...
Finora abbiamo studiato le probabilità di eventi discreti, come vincere il gioco di Monty Hall o ricevere una diagnosi medica accurata. Tuttavia, molte situazioni pratiche richiedono una comprensione più sottile e quantitativa dell'incertezza. Invece di chiederci semplicemente se qualcosa accadrà, spesso abbiamo bisogno di sapere con quale frequenza accadrà, per quanto tempo durerà o quale valore numerico possiamo aspettarci.

Per esempio, potremmo voler determinare quanti tentativi sono necessari prima che un concorrente vinca in uno scenario simile a quello del gioco di Monty Hall o stimare la durata attesa di un trattamento medico. Allo stesso modo, giocando per molte ore con un dado sbilanciato, potremmo essere interessati a calcolare la perdita finanziaria media che possiamo aspettarci nel lungo periodo. 

Queste domande richiedono un approccio più sofisticato rispetto alla semplice valutazione della probabilità di eventi isolati. Implicano la quantificazione di risultati numerici che emergono da processi casuali. Per affrontare in modo sistematico questo tipo di problemi, introduciamo il concetto fondamentale di *variabile casuale*. 

Una variabile casuale è una funzione che associa un valore numerico a ogni possibile risultato di un esperimento casuale. Questo strumento matematico ci permette di tradurre l'incertezza qualitativa in quantità misurabili e di calcolare valori attesi, varianze e altre caratteristiche distributive. Grazie alle variabili casuali, possiamo non solo prevedere se un evento si verificherà, ma anche come si manifesterà numericamente quando si verifica.

In questo capitolo esploreremo le proprietà fondamentali delle variabili casuali, gettando le basi per affrontare le questioni pratiche che richiedono una comprensione quantitativa del comportamento aleatorio nei sistemi complessi.
