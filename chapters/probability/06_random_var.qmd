...
Una variabile casuale è, in sostanza, una funzione che associa un valore numerico a ogni possibile risultato di un esperimento casuale. Questo potente strumento matematico ci permette di tradurre l'incertezza qualitativa in quantità misurabili e di calcolare valori attesi, varianze e altre caratteristiche distributive. Grazie alle variabili casuali, possiamo non solo prevedere se un evento si verificherà, ma anche come si manifesterà numericamente quando si verifica.
...
Nel linguaggio del calcolo delle probabilità, una *variabile casuale* rappresenta un ponte formale tra il mondo degli eventi qualitativi e quello dell'analisi numerica. Essa formalizza l'idea di assegnare un valore numerico a ciascun possibile risultato di un esperimento aleatorio, trasformando così esiti anche non numerici — come il seme di una carta da gioco o l'esito di un test medico — in quantità misurabili. Questa traduzione in valori numerici è fondamentale per applicare gli strumenti propri della teoria della probabilità e dell'analisi statistica allo studio dei fenomeni aleatori.
