...
### Esempio concreto: la distribuzione Beta nel duplice ruolo
...
### Ponte applicativo: come scegliere la distribuzione appropriata
...
#### 1. Qual è il **supporto** della variabile? {.unnumbered .unlisted}
...
#### 2. Qual è la **forma attesa** della distribuzione? {.unnumbered .unlisted}
...
* Asimmetrica a sinistra → **Beta** con (\alpha > \beta)
...
#### 3. Ci sono **informazioni pregresse** da incorporare? {.unnumbered .unlisted}
...
#### Esempio applicativo {.unnumbered .unlisted}

> *“Devo modellare i tempi di reazione in un esperimento di priming.”*

1. **Supporto**
   I tempi di reazione sono numeri reali positivi → la **Normale è esclusa**.

2. **Forma attesa**
   I tempi di reazione mostrano tipicamente una forte asimmetria a destra → candidati naturali: **Gamma** o **Log-normale**.

3. **Considerazioni di modellazione**
...
### In sintesi {.unnumbered .unlisted}

Scegliere una distribuzione significa rispondere a tre domande fondamentali:

1. *Quali valori sono possibili?*
2. *Che forma mi aspetto realisticamente?*
3. *Che tipo di inferenza voglio costruire (frequentista o bayesiana)?*
