...
Questa concezione, sviluppata da pensatori come Thomas Bayes, Pierre‑Simon Laplace e Bruno de Finetti, offre un quadro concettuale particolarmente adatto alle scienze psicologiche, dove siamo spesso chiamati a ragionare in condizioni di informazione incompleta, rumore e variabilità individuale.

Dal punto di vista bayesiano, gli assiomi della probabilità non descrivono leggi fisiche del caso, ma **vincoli di coerenza logica** tra le nostre valutazioni di incertezza. Essi definiscono come le nostre credenze *devono* relazionarsi tra loro per evitare contraddizioni interne. Violare questi vincoli rende le assegnazioni di probabilità incoerenti e può condurre a conclusioni irrazionali o a scelte decisionali sistematicamente svantaggiose.

Nel corso del modulo faremo ampio uso di **simulazioni al computer**. Il loro scopo non è definire in astratto “che cos’è” la probabilità, ma mostrare come un sistema di credenze coerente si comporta quando entra in contatto con i dati empirici. Le simulazioni ci permetteranno di esplorare in modo concreto e intuitivo le conseguenze delle regole probabilistiche e di apprezzare perché l’approccio bayesiano costituisca uno strumento potente e flessibile per modellare il ragionamento e l’analisi dei dati in psicologia.

## Perché la probabilità bayesiana in psicologia? {.unnumbered .unlisted}

La ricerca psicologica presenta caratteristiche che rendono l’approccio bayesiano particolarmente adatto:

1.  **Campioni di dimensioni limitate.** In molti contesti clinici e sperimentali, la numerosità campionaria è spesso ridotta (es. $n$ = 20–50). L'inferenza bayesiana permette di incorporare in modo trasparente le conoscenze pregresse per compensare la limitata informazione proveniente dai dati.

2.  **Conoscenze cumulative e informazione pregressa.** Raramente uno studio parte da zero. Disponiamo di meta-analisi, studi pilota e teorie consolidate. I *prior* offrono un mezzo rigoroso per formalizzare e integrare questa conoscenza già esistente nel processo inferenziale.

3.  **Interpretazione intuitiva e direttamente applicabile.** Un'affermazione come "c'è una probabilità del 95% che l'effetto si collochi tra 0.2 e 0.8" è più immediata e comprensibile dell'interpretazione contorta del tipico intervallo di confidenza frequentista ("se ripetessimo questo esperimento infinite volte, nel 95% dei casi l'intervallo calcolato conterrebbe il vero parametro"). Questo facilita enormemente il dialogo tra ricerca, teoria e pratica.

::: {.callout-note collapse="true" title="Esempio concreto"}

**Scenario**: Sei uno psicologo clinico e devi valutare l'efficacia di un nuovo trattamento per l'ansia. Hai a disposizione solo 15 pazienti per uno studio pilota.

**Approccio tradizionale**: “Il campione è troppo piccolo. Non posso trarre conclusioni statisticamente valide. Servirebbero molti più partecipanti.”

**Approccio bayesiano**: “Posso incorporare le evidenze di studi precedenti simili attraverso un *prior* informativo. Aggiorno quindi queste credenze con i dati raccolti sui 15 pazienti. Il risultato è una distribuzione a posteriori che quantifica in modo rigoroso l’effetto stimato *e* l’incertezza residua, guidandomi in una decisione clinica razionale anche con dati limitati.”
:::
...
In ambito psicologico, questa forma di incertezza include la variabilità comportamentale residua anche in condizioni sperimentali controllate, la natura probabilisticamente distribuita delle decisioni in situazioni ambigue e l’emergere spontaneo di fenomeni come l’insight, la creatività o i cambiamenti improvvisi di strategia cognitiva.
...
Questa scelta si fonda su una premessa epistemologica: l’accesso dell’osservatore allo stato del sistema è *sempre* parziale. Di conseguenza, la probabilità diviene lo strumento con cui quantifichiamo sistematicamente i limiti della nostra conoscenza, a prescindere dal fatto che essi derivino da informazioni incomplete o dalla complessità inerente al fenomeno studiato.
...
Sotto questa prospettiva, gli assiomi della probabilità assumono un nuovo significato: non sono semplicemente regole matematiche, ma **principi di coerenza logica** che vincolano le nostre credenze. Rappresentano requisiti minimi di razionalità, la cui violazione porterebbe inevitabilmente a contraddizioni interne e a scelte decisionali sistematicamente svantaggiose.
...
Nei prossimi capitoli svilupperemo gli strumenti formali di questo approccio. Scopriremo come concetti spesso considerati oggettivi, come ad esempio l’equiprobabilità, non siano proprietà intrinseche del mondo, ma riflettano **simmetrie nel nostro stato informativo**. La probabilità bayesiana non elimina l’incertezza; piuttosto, offre un **linguaggio matematico per quantificarla, comunicarla e gestirla in modo razionale**.
