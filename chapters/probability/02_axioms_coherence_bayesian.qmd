...
- L'**angolo in basso a destra** deve valere 1: la somma di tutte le celle (e di tutte le marginali) è 1.
...
Ogni cella rappresenta la probabilità di una combinazione: veri positivi (0.1275), falsi negativi (0.0225), falsi positivi (0.1700), veri negativi (0.6800). La somma è 1.
...
La convergenza delle frequenze empiriche verso le probabilità teoriche conferma che la distribuzione congiunta è un sistema coerente che specifica un *modello generativo* del mondo.
