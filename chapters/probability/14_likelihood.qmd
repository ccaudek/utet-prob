...
Nella pratica della ricerca scientifica, tuttavia, il problema che si presenta è spesso di natura opposta. I dati vengono osservati per primi, e ciò che si desidera comprendere è quali valori dei parametri del modello siano più plausibili alla luce di quell’evidenza empirica. Questo ribaltamento di prospettiva — dal calcolo della probabilità dei dati dato il modello alla valutazione dei parametri dato l’insieme dei dati osservati — costituisce il nucleo dell’inferenza statistica.
